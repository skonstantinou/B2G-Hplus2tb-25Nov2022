...
// ------------>Primitives in pad: NJets_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMinimum(0.9925281);
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMaximum(1.007472);
   ...
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMinimum(0.9925281);
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMaximum(1.007472);
   ...
   Graph_Graph_Graph_Graph1370537093713->SetMinimum(0.9712289);
   Graph_Graph_Graph_Graph1370537093713->SetMaximum(0.9894453);
...
// ------------>Primitives in pad: NJets_1
   ...
   NJets_1->Draw();
   NJets_1->cd();
   NJets_1->Range(5.379747,-1.231162,15.50633,5.481421);
   ...
   hframe__1172->SetMaximum(119857.9);
   ...
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMinimum(211.3295);
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMaximum(22615.8);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,438.3196);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,10.35164);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,10405.69);
   TT_stack_2_stack_2_stack_2->SetBinError(1,24.74705);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,6172.585);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,102.5036);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3639.657);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinContent(1,32.71815);
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinError(1,2.069209);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMinimum(16889.45);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMaximum(17143.74);
   ...
   Data__1174->SetBinContent(1,16682);
   Data__1174->SetBinError(1,129.1588);
   ...
   hframe_copy__1175->SetMaximum(119857.9);
   ...
   hframe_copy__1176->SetMaximum(119857.9);
