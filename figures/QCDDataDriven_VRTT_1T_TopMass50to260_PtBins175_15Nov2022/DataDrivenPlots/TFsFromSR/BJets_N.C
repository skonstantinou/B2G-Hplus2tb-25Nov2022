...
//=========  (Wed Nov 16 12:08:49 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: BJets_N_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError336733713375->SetMinimum(0.9925281);
   Graph_Graph_Graph_BackgroundStatSystError336733713375->SetMaximum(1.007472);
   ...
   Graph_Graph_Graph_BackgroundStatError336833723376->SetMinimum(0.9925281);
   Graph_Graph_Graph_BackgroundStatError336833723376->SetMaximum(1.007472);
   ...
   Graph_Graph_Graph_Graph1336933733377->SetMinimum(0.9712252);
   Graph_Graph_Graph_Graph1336933733377->SetMaximum(0.9894415);
...
// ------------>Primitives in pad: BJets_N_1
   ...
   BJets_N_1->Draw();
   BJets_N_1->cd();
   BJets_N_1->Range(-3.645569,-1.231162,19.13924,5.481423);
   ...
   hframe__626->SetMaximum(119858.3);
   ...
   StackedMCstackHist_stack_88_stack_89_stack_90->SetMinimum(6.806664);
   StackedMCstackHist_stack_88_stack_89_stack_90->SetMaximum(27226.66);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,438.3196);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,10.35164);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,10405.77);
   TT_stack_2_stack_2_stack_2->SetBinError(3,24.74705);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,6172.566);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,102.5035);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3639.589);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__627->SetBinContent(3,32.7182);
   ChargedHiggs_HplusTBHplusToTB_M_800__627->SetBinError(3,2.069209);
   ChargedHiggs_HplusTBHplusToTB_M_800__627->SetEntries(5945);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors337033743378->SetMinimum(18.83488);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors337033743378->SetMaximum(18834.88);
   ...
   Data__628->SetBinContent(3,16682);
   Data__628->SetBinError(3,129.1588);
   Data__628->SetEntries(16686);
   ...
   hframe_copy__629->SetMaximum(119858.3);
   ...
   hframe_copy__630->SetMaximum(119858.3);
