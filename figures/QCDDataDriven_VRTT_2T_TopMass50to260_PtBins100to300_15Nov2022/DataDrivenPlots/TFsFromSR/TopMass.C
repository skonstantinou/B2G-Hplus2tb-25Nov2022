...
//=========  (Fri Nov 18 13:29:08 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: TopMass_2
   ...
   Double_t BackgroundStatSystError_fx3409[2] = {
   125,
   175};
   Double_t BackgroundStatSystError_fy3409[2] = {
   1,
   1};
   Double_t BackgroundStatSystError_felx3409[2] = {
   25,
   25};
   Double_t BackgroundStatSystError_fely3409[2] = {
   0.0147972,
   0.003031164};
   Double_t BackgroundStatSystError_fehx3409[2] = {
   25,
   25};
   Double_t BackgroundStatSystError_fehy3409[2] = {
   0.0147972,
   0.003031164};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(2,BackgroundStatSystError_fx3409,BackgroundStatSystError_fy3409,BackgroundStatSystError_felx3409,BackgroundStatSystError_fehx3409,BackgroundStatSystError_fely3409,BackgroundStatSystError_fehy3409);
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409 = new TH1F("Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409","Graph",100,90,210);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409->SetMinimum(0.9822434);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409->SetMaximum(1.017757);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33983400340434063410->SetMinimum(0.9822434);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33983400340434063410->SetMaximum(1.017757);
   ...
   Double_t BackgroundStatSystError_fx3411[2] = {
   125,
   175};
   Double_t BackgroundStatSystError_fy3411[2] = {
   1,
   1};
   Double_t BackgroundStatSystError_felx3411[2] = {
   25,
   25};
   Double_t BackgroundStatSystError_fely3411[2] = {
   0.0147972,
   0.003031164};
   Double_t BackgroundStatSystError_fehx3411[2] = {
   25,
   25};
   Double_t BackgroundStatSystError_fehy3411[2] = {
   0.0147972,
   0.003031164};
   grae = new TGraphAsymmErrors(2,BackgroundStatSystError_fx3411,BackgroundStatSystError_fy3411,BackgroundStatSystError_felx3411,BackgroundStatSystError_fehx3411,BackgroundStatSystError_fely3411,BackgroundStatSystError_fehy3411);
   grae->SetName("BackgroundStatSystError");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411 = new TH1F("Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411","Graph",100,90,210);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411->SetMinimum(0.9822434);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411->SetMaximum(1.017757);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError339834003404340634103412->SetMinimum(0.9822434);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError339834003404340634103412->SetMaximum(1.017757);
   ...
   Double_t Graph0_fx3413[2] = {
   125,
   175};
   Double_t Graph0_fy3413[2] = {
   1.009372,
   0.9400503};
   Double_t Graph0_felx3413[2] = {
   25,
   25};
   Double_t Graph0_fely3413[2] = {
   0.0204049,
   0.004584466};
   Double_t Graph0_fehx3413[2] = {
   25,
   25};
   Double_t Graph0_fehy3413[2] = {
   0.0204049,
   0.004584466};
   grae = new TGraphAsymmErrors(2,Graph0_fx3413,Graph0_fy3413,Graph0_felx3413,Graph0_fehx3413,Graph0_fely3413,Graph0_fehy3413);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph0340134073413 = new TH1F("Graph_Graph_Graph_Graph0340134073413","Graph",100,90,210);
   Graph_Graph_Graph_Graph0340134073413->SetMinimum(0.9260347);
   Graph_Graph_Graph_Graph0340134073413->SetMaximum(1.039209);
...
// ------------>Primitives in pad: TopMass_1
   ...
   TopMass_1->Draw();
   TopMass_1->cd();
   TopMass_1->Range(-202.5316,-1.240256,1063.291,5.927023);
   ...
   hframe__689->SetMaximum(314040.8);
   ...
   StackedMCstackHist_stack_97_stack_98_stack_99->SetMinimum(17.89096);
   StackedMCstackHist_stack_97_stack_98_stack_99->SetMaximum(71563.83);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,64.85858);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,1116.677);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,4.163181);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,15.89054);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,1640.83);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,36948.05);
   TT_stack_2_stack_2_stack_2->SetBinError(3,9.581262);
   TT_stack_2_stack_2_stack_2->SetBinError(4,45.09204);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,718.5901);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(4,6662.663);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,34.31773);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(4,126.8663);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3287.304);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(3,5.737624);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(4,100.9476);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(3,0.8286651);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(4,3.580015);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetEntries(19326);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors340234083414->SetMinimum(49.34927);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors340234083414->SetMaximum(49349.27);
   ...
   Data__691->SetBinContent(3,2447);
   Data__691->SetBinContent(4,42046);
   Data__691->SetBinError(3,49.46716);
   Data__691->SetBinError(4,205.0512);
   Data__691->SetEntries(44497);
   ...
   line = new TLine(173.21,0.08,173.21,314040.8);
   ...
   hframe_copy__692->SetMaximum(314040.8);
   ...
   hframe_copy__693->SetMaximum(314040.8);
