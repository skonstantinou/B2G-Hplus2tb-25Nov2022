...
//=========  (Fri Nov 18 13:34:52 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: NJets_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMinimum(0.9964309);
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMaximum(1.003569);
   ...
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMinimum(0.9964309);
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMaximum(1.003569);
   ...
   Graph_Graph_Graph_Graph1370537093713->SetMinimum(0.9382529);
   Graph_Graph_Graph_Graph1370537093713->SetMaximum(0.9489894);
...
// ------------>Primitives in pad: NJets_1
   ...
   NJets_1->Draw();
   NJets_1->cd();
   NJets_1->Range(5.379747,-1.240753,15.50633,5.951412);
   ...
   hframe__1172->SetMaximum(331041.1);
   ...
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMinimum(574.1203);
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMaximum(62738.49);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,1181.535);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,16.42685);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,38588.58);
   TT_stack_2_stack_2_stack_2->SetBinError(1,46.09873);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,7381.222);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,131.4258);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3287.281);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinContent(1,106.6851);
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinError(1,3.674669);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMinimum(46983.05);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMaximum(47319.63);
   ...
   Data__1174->SetBinContent(1,44493);
   Data__1174->SetBinError(1,210.9336);
   ...
   hframe_copy__1175->SetMaximum(331041.1);
   ...
   hframe_copy__1176->SetMaximum(331041.1);
