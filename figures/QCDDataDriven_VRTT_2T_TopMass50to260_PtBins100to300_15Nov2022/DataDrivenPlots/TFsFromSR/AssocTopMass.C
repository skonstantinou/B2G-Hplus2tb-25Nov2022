...
// ------------>Primitives in pad: AssocTopMass_2
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMinimum(0.9384838);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMaximum(1.061516);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMinimum(0.9384838);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMaximum(1.061516);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMinimum(0.9384838);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMaximum(1.061516);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMinimum(0.9384838);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMaximum(1.061516);
   ...
   Graph_Graph_Graph_Graph0334133473353->SetMinimum(0.5486264);
   Graph_Graph_Graph_Graph0334133473353->SetMaximum(1.119781);
...
// ------------>Primitives in pad: AssocTopMass_1
   ...
   AssocTopMass_1->Draw();
   AssocTopMass_1->cd();
   AssocTopMass_1->Range(-202.5316,-1.237367,1063.291,5.785497);
   ...
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMinimum(12.39367);
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMaximum(49574.7);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,220.3662);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,866.5744);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,94.59466);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,6.975679);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,14.22);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,4.355771);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,6164.413);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,30117.61);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,2306.771);
   TT_stack_2_stack_2_stack_2->SetBinError(3,18.53002);
   TT_stack_2_stack_2_stack_2->SetBinError(4,40.60803);
   TT_stack_2_stack_2_stack_2->SetBinError(5,11.52038);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,1314.833);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,2097.507);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,3170.147);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(6,798.7664);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,47.40284);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,70.97649);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,91.16692);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(6,40.94753);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3287.298);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(3,17.05005);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(4,79.65466);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(5,9.980499);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(3,1.496622);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(4,3.12275);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(5,1.229532);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetEntries(19326);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMinimum(34.12993);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMaximum(34129.93);
   ...
   Data__607->SetBinContent(3,8074);
   Data__607->SetBinContent(4,33039);
   Data__607->SetBinContent(5,3380);
   Data__607->SetBinError(3,89.85544);
   Data__607->SetBinError(4,181.7663);
   Data__607->SetBinError(5,58.13777);
   Data__607->SetEntries(44497);
   ...
   line = new TLine(173.21,0.08,173.21,231273);
   ...
   hframe_copy__608->SetMaximum(231273);
   ...
   hframe_copy__609->SetMaximum(231273);
