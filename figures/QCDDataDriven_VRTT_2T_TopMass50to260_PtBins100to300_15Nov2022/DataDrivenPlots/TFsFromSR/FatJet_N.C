...
//=========  (Wed Nov 16 12:11:02 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: FatJet_N_2
   ...
   Double_t BackgroundStatSystError_fx3435[5] = {
   0.5,
   1.5,
   2.5,
   3.5,
   4.5};
   Double_t BackgroundStatSystError_fy3435[5] = {
   1,
   1,
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3435[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t BackgroundStatSystError_fely3435[5] = {
   0.003165252,
   0.009773324,
   0.01503402,
   1.420266,
   1};
   Double_t BackgroundStatSystError_fehx3435[5] = {
   0.5,
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t BackgroundStatSystError_fehy3435[5] = {
   0.003165252,
   0.009773324,
   0.01503402,
   1.420266,
   1};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(5,BackgroundStatSystError_fx3435,BackgroundStatSystError_fy3435,BackgroundStatSystError_felx3435,BackgroundStatSystError_fehx3435,BackgroundStatSystError_fely3435,BackgroundStatSystError_fehy3435);
   ...
   TH1F *Graph_Graph_Graph_BackgroundStatSystError342734313435 = new TH1F("Graph_Graph_Graph_BackgroundStatSystError342734313435","Graph",100,0,5.5);
   Graph_Graph_Graph_BackgroundStatSystError342734313435->SetMinimum(-0.704319);
   Graph_Graph_Graph_BackgroundStatSystError342734313435->SetMaximum(2.704319);
   ...
   Graph_Graph_Graph_BackgroundStatError342834323436->SetMinimum(-0.704319);
   Graph_Graph_Graph_BackgroundStatError342834323436->SetMaximum(2.704319);
   ...
   Double_t Graph1_fx3437[4] = {
   0.5,
   1.5,
   2.5,
   3.5};
   Double_t Graph1_fy3437[4] = {
   0.9347573,
   1.021832,
   1.030446,
   14.74251};
   Double_t Graph1_felx3437[4] = {
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph1_fely3437[4] = {
   0.004693364,
   0.01606845,
   0.03687227,
   14.74251};
   Double_t Graph1_fehx3437[4] = {
   0.5,
   0.5,
   0.5,
   0.5};
   Double_t Graph1_fehy3437[4] = {
   0.004693364,
   0.01606845,
   0.03687227,
   14.74251};
   grae = new TGraphAsymmErrors(4,Graph1_fx3437,Graph1_fy3437,Graph1_felx3437,Graph1_fehx3437,Graph1_fely3437,Graph1_fehy3437);
   grae->SetName("Graph1");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph1342934333437 = new TH1F("Graph_Graph_Graph_Graph1342934333437","Graph",100,0,4.4);
   Graph_Graph_Graph_Graph1342934333437->SetMinimum(0);
   Graph_Graph_Graph_Graph1342934333437->SetMaximum(32.43351);
...
// ------------>Primitives in pad: FatJet_N_1
   ...
   FatJet_N_1->Draw();
   FatJet_N_1->cd();
   FatJet_N_1->Range(-1.21519,-2.162483,6.379747,5.961649);
   ...
   hframe__710->SetMaximum(297989.5);
   ...
   StackedMCstackHist_stack_100_stack_101_stack_102->SetMinimum(16.97425);
   StackedMCstackHist_stack_100_stack_101_stack_102->SetMaximum(67896.98);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,1019.101);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(2,138.4274);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,23.99052);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,0.01636429);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,0.0001317472);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,15.28774);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(2,5.424346);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,2.588941);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,0.006770288);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,0.0001317472);
   tEWttX_stack_1_stack_1_stack_1->SetEntries(5173.511);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,34434.68);
   TT_stack_2_stack_2_stack_2->SetBinContent(2,3427.139);
   TT_stack_2_stack_2_stack_2->SetBinContent(3,726.569);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,0.1073833);
   TT_stack_2_stack_2_stack_2->SetBinError(1,43.56041);
   TT_stack_2_stack_2_stack_2->SetBinError(2,13.70636);
   TT_stack_2_stack_2_stack_2->SetBinError(3,6.301835);
   TT_stack_2_stack_2_stack_2->SetBinError(4,0.07596748);
   TT_stack_2_stack_2_stack_2->SetEntries(700709.2);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,6981.832);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,392.0299);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,7.364391);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(4,-0.05591648);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,126.1368);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,35.75985);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,9.133576);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(4,0.05885701);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3154.212);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(1,78.51681);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(2,24.39327);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(3,3.792408);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(4,-0.01718081);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(1,3.110934);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(2,1.828938);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(3,0.6894195);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(4,0.0705157);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetEntries(842.8935);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors343034343438->SetMinimum(46.82693);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors343034343438->SetMaximum(46826.93);
   ...
   Data__712->SetBinContent(1,39667);
   Data__712->SetBinContent(2,4044);
   Data__712->SetBinContent(3,781);
   Data__712->SetBinContent(4,1);
   Data__712->SetBinError(1,199.1658);
   Data__712->SetBinError(2,63.59245);
   Data__712->SetBinError(3,27.94638);
   Data__712->SetBinError(4,1);
   Data__712->SetEntries(44493);
   ...
   hframe_copy__713->SetMaximum(297989.5);
   ...
   hframe_copy__714->SetMaximum(297989.5);
