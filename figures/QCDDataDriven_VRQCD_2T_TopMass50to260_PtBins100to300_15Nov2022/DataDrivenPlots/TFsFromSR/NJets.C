...
//=========  (Fri Nov 18 13:35:02 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: NJets_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMinimum(0.9902872);
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMaximum(1.009713);
   ...
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMinimum(0.9902872);
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMaximum(1.009713);
   ...
   Graph_Graph_Graph_Graph1370537093713->SetMinimum(0.991373);
   Graph_Graph_Graph_Graph1370537093713->SetMaximum(1.012389);
...
// ------------>Primitives in pad: NJets_1
   ...
   NJets_1->Draw();
   NJets_1->cd();
   NJets_1->Range(5.379747,-1.228685,15.50633,5.360082);
   ...
   hframe__1172->SetMaximum(92205.29);
   ...
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMinimum(134.2597);
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMaximum(17558.23);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,285.4629);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,8.07979);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,3959.459);
   TT_stack_2_stack_2_stack_2->SetBinError(1,15.29455);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,8821.503);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,104.3351);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinContent(1,21.26081);
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinError(1,1.769076);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMinimum(12939.51);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMaximum(13193.34);
   ...
   Data__1174->SetBinContent(1,13091);
   Data__1174->SetBinError(1,114.4159);
   ...
   hframe_copy__1175->SetMaximum(92205.29);
   ...
   hframe_copy__1176->SetMaximum(92205.29);
