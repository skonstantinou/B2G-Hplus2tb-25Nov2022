...
// ------------>Primitives in pad: AssocTopMass_2
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMinimum(0.957973);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMaximum(1.042027);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMinimum(0.957973);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMaximum(1.042027);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMinimum(0.957973);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMaximum(1.042027);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMinimum(0.957973);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMaximum(1.042027);
   ...
   Graph_Graph_Graph_Graph0334133473353->SetMinimum(0.0538642);
   Graph_Graph_Graph_Graph0334133473353->SetMaximum(3.134065);
...
// ------------>Primitives in pad: AssocTopMass_1
   ...
   AssocTopMass_1->Draw();
   AssocTopMass_1->cd();
   AssocTopMass_1->Range(-202.5316,-1.224961,1063.291,5.177565);
   ...
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMinimum(1.987731);
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMaximum(7950.925);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,53.87237);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,198.9857);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,32.60489);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,3.926685);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,6.410778);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,2.960755);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,690.4299);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,2919.205);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,349.825);
   TT_stack_2_stack_2_stack_2->SetBinError(3,6.424911);
   TT_stack_2_stack_2_stack_2->SetBinError(4,13.08686);
   TT_stack_2_stack_2_stack_2->SetBinError(5,4.623635);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,1151.738);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,2086.286);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,4586.898);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(6,996.5783);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,35.13963);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,50.74841);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,76.53381);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(6,34.90269);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(3,3.708106);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(4,14.52998);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(5,3.022731);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(3,0.7243053);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(4,1.479291);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(5,0.6455314);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetEntries(4205);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMinimum(5.550665);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMaximum(5550.665);
   ...
   Data__607->SetBinContent(3,2630);
   Data__607->SetBinContent(4,8878);
   Data__607->SetBinContent(5,1583);
   Data__607->SetBinError(3,51.28353);
   Data__607->SetBinError(4,94.22314);
   Data__607->SetBinError(5,39.78693);
   Data__607->SetEntries(13095);
   ...
   line = new TLine(173.21,0.08,173.21,62146);
   ...
   hframe_copy__608->SetMaximum(62146);
   ...
   hframe_copy__609->SetMaximum(62146);
