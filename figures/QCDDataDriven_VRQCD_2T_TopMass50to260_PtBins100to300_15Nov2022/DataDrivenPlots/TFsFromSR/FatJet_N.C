...
//=========  (Wed Nov 16 12:11:03 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: FatJet_N_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError342734313435->SetMinimum(0.9142532);
   Graph_Graph_Graph_BackgroundStatSystError342734313435->SetMaximum(1.085747);
   ...
   Graph_Graph_Graph_BackgroundStatError342834323436->SetMinimum(0.9142532);
   Graph_Graph_Graph_BackgroundStatError342834323436->SetMaximum(1.085747);
   ...
   Graph_Graph_Graph_Graph1342934333437->SetMinimum(-53.09955);
   Graph_Graph_Graph_Graph1342934333437->SetMaximum(6.100776);
...
// ------------>Primitives in pad: FatJet_N_1
   ...
   FatJet_N_1->Draw();
   FatJet_N_1->cd();
   FatJet_N_1->Range(-1.21519,-2.150877,6.379747,5.392979);
   ...
   hframe__710->SetMaximum(87166.18);
   ...
   StackedMCstackHist_stack_100_stack_101_stack_102->SetMinimum(4.939608);
   StackedMCstackHist_stack_100_stack_101_stack_102->SetMaximum(19758.43);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,256.9165);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(2,23.29094);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,5.254282);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,0.001262456);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,7.737065);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(2,2.094746);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,1.016299);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,0.0005191585);
   tEWttX_stack_1_stack_1_stack_1->SetEntries(1248.244);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,3594.302);
   TT_stack_2_stack_2_stack_2->SetBinContent(2,288.3885);
   TT_stack_2_stack_2_stack_2->SetBinContent(3,76.76491);
   TT_stack_2_stack_2_stack_2->SetBinError(1,14.58736);
   TT_stack_2_stack_2_stack_2->SetBinError(2,4.105234);
   TT_stack_2_stack_2_stack_2->SetBinError(3,2.068628);
   TT_stack_2_stack_2_stack_2->SetEntries(67018.91);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,8497.801);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,298.0644);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,25.675);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(4,-0.04278536);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,101.9643);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,20.86092);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,7.342106);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(4,0.04114231);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(1,16.508);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(2,3.755347);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinContent(3,0.9974796);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(1,1.549675);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(2,0.782818);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetBinError(3,0.3396077);
   ChargedHiggs_HplusTBHplusToTB_M_800__711->SetEntries(144.4332);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors343034343438->SetMinimum(13.69754);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors343034343438->SetMaximum(13697.54);
   ...
   Data__712->SetBinContent(1,12339);
   Data__712->SetBinContent(2,635);
   Data__712->SetBinContent(3,115);
   Data__712->SetBinContent(4,2);
   Data__712->SetBinError(1,111.0811);
   Data__712->SetBinError(2,25.19921);
   Data__712->SetBinError(3,10.72381);
   Data__712->SetBinError(4,1.414214);
   Data__712->SetEntries(13091);
   ...
   hframe_copy__713->SetMaximum(87166.18);
   ...
   hframe_copy__714->SetMaximum(87166.18);
