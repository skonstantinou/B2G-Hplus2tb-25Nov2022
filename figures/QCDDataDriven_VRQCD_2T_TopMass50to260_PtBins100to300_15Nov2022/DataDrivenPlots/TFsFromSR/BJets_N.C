...
//=========  (Wed Nov 16 12:10:50 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: BJets_N_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError336733713375->SetMinimum(0.9902872);
   Graph_Graph_Graph_BackgroundStatSystError336733713375->SetMaximum(1.009713);
   ...
   Graph_Graph_Graph_BackgroundStatError336833723376->SetMinimum(0.9902872);
   Graph_Graph_Graph_BackgroundStatError336833723376->SetMaximum(1.009713);
   ...
   Graph_Graph_Graph_Graph1336933733377->SetMinimum(0.9913735);
   Graph_Graph_Graph_Graph1336933733377->SetMaximum(1.012389);
...
// ------------>Primitives in pad: BJets_N_1
   ...
   BJets_N_1->Draw();
   BJets_N_1->cd();
   BJets_N_1->Range(-3.645569,-1.228685,19.13924,5.360082);
   ...
   hframe__626->SetMaximum(92205.24);
   ...
   StackedMCstackHist_stack_88_stack_89_stack_90->SetMinimum(5.226567);
   StackedMCstackHist_stack_88_stack_89_stack_90->SetMaximum(20906.27);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,285.463);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,8.07979);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,3959.458);
   TT_stack_2_stack_2_stack_2->SetBinError(3,15.29455);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,8821.497);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,104.3351);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__627->SetBinContent(3,21.26083);
   ChargedHiggs_HplusTBHplusToTB_M_800__627->SetBinError(3,1.769076);
   ChargedHiggs_HplusTBHplusToTB_M_800__627->SetEntries(4205);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors337033743378->SetMinimum(14.48939);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors337033743378->SetMaximum(14489.39);
   ...
   Data__628->SetBinContent(3,13091);
   Data__628->SetBinError(3,114.4159);
   Data__628->SetEntries(13095);
   ...
   hframe_copy__629->SetMaximum(92205.24);
   ...
   hframe_copy__630->SetMaximum(92205.24);
