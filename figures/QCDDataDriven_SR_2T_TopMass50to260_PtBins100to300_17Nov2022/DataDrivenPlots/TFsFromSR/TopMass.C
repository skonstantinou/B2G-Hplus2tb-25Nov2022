...
//=========  (Fri Nov 18 13:28:20 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: TopMass_2
   ...
   Double_t BackgroundStatSystError_fx3409[3] = {
   125,
   175,
   225};
   Double_t BackgroundStatSystError_fy3409[3] = {
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3409[3] = {
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fely3409[3] = {
   0.01859223,
   0.008232597,
   0.02268416};
   Double_t BackgroundStatSystError_fehx3409[3] = {
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fehy3409[3] = {
   0.01859223,
   0.008232597,
   0.02268416};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(3,BackgroundStatSystError_fx3409,BackgroundStatSystError_fy3409,BackgroundStatSystError_felx3409,BackgroundStatSystError_fehx3409,BackgroundStatSystError_fely3409,BackgroundStatSystError_fehy3409);
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409 = new TH1F("Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409","Graph",100,85,265);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409->SetMinimum(0.972779);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409->SetMaximum(1.027221);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33983400340434063410->SetMinimum(0.972779);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33983400340434063410->SetMaximum(1.027221);
   ...
   Double_t BackgroundStatSystError_fx3411[3] = {
   125,
   175,
   225};
   Double_t BackgroundStatSystError_fy3411[3] = {
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3411[3] = {
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fely3411[3] = {
   0.01859223,
   0.008232597,
   0.02268416};
   Double_t BackgroundStatSystError_fehx3411[3] = {
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fehy3411[3] = {
   0.01859223,
   0.008232597,
   0.02268416};
   grae = new TGraphAsymmErrors(3,BackgroundStatSystError_fx3411,BackgroundStatSystError_fy3411,BackgroundStatSystError_felx3411,BackgroundStatSystError_fehx3411,BackgroundStatSystError_fely3411,BackgroundStatSystError_fehy3411);
   grae->SetName("BackgroundStatSystError");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411 = new TH1F("Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411","Graph",100,85,265);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411->SetMinimum(0.972779);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411->SetMaximum(1.027221);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError339834003404340634103412->SetMinimum(0.972779);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError339834003404340634103412->SetMaximum(1.027221);
   ...
   Double_t Graph0_fx3413[3] = {
   125,
   175,
   225};
   Double_t Graph0_fy3413[3] = {
   1.020844,
   1.008987,
   1.005638};
   Double_t Graph0_felx3413[3] = {
   25,
   25,
   25};
   Double_t Graph0_fely3413[3] = {
   0.02035186,
   0.009509014,
   0.02449863};
   Double_t Graph0_fehx3413[3] = {
   25,
   25,
   25};
   Double_t Graph0_fehy3413[3] = {
   0.02035186,
   0.009509014,
   0.02449863};
   grae = new TGraphAsymmErrors(3,Graph0_fx3413,Graph0_fy3413,Graph0_felx3413,Graph0_fehx3413,Graph0_fely3413,Graph0_fehy3413);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph0340134073413 = new TH1F("Graph_Graph_Graph_Graph0340134073413","Graph",100,85,265);
   Graph_Graph_Graph_Graph0340134073413->SetMinimum(0.9751339);
   Graph_Graph_Graph_Graph0340134073413->SetMaximum(1.047201);
...
// ------------>Primitives in pad: TopMass_1
   ...
   TopMass_1->Draw();
   TopMass_1->cd();
   TopMass_1->Range(-202.5316,-1.227204,1063.291,5.287479);
   ...
   StackedMCstackHist_stack_97_stack_98_stack_99->SetMinimum(4.463488);
   StackedMCstackHist_stack_97_stack_98_stack_99->SetMaximum(17853.95);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,80.2198);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,454.9021);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,58.80503);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,3.4012);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,8.206898);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,2.955615);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,921.8702);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,6137.831);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,623.8774);
   TT_stack_2_stack_2_stack_2->SetBinError(3,7.600582);
   TT_stack_2_stack_2_stack_2->SetBinError(4,19.44412);
   TT_stack_2_stack_2_stack_2->SetBinError(5,6.305863);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,1462.537);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(4,4565.988);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,992.8705);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,45.06);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(4,89.40803);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,37.36506);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(3,66.08804);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(4,489.393);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(5,48.44537);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(3,2.495375);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(4,6.72621);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(5,2.348202);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetEntries(120993);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors340234083414->SetMinimum(12.37564);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors340234083414->SetMaximum(12375.64);
   ...
   Data__691->SetBinContent(3,2516);
   Data__691->SetBinContent(4,11259);
   Data__691->SetBinContent(5,1685);
   Data__691->SetBinError(3,50.15974);
   Data__691->SetBinError(4,106.1084);
   Data__691->SetBinError(5,41.04875);
   Data__691->SetEntries(15464);
   ...
   line = new TLine(173.21,0.08,173.21,78813);
   ...
   hframe_copy__692->SetMaximum(78813);
   ...
   hframe_copy__693->SetMaximum(78813);
