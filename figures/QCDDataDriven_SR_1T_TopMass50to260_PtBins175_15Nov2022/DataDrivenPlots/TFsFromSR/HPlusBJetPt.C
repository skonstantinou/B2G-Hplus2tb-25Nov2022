...
//=========  (Fri Nov 18 13:28:27 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: HPlusBJetPt_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError349935033507->SetMinimum(0.8436827);
   Graph_Graph_Graph_BackgroundStatSystError349935033507->SetMaximum(1.156317);
   ...
   Graph_Graph_Graph_BackgroundStatError350035043508->SetMinimum(0.8436827);
   Graph_Graph_Graph_BackgroundStatError350035043508->SetMaximum(1.156317);
   ...
   Graph_Graph_Graph_Graph1350135053509->SetMinimum(0.6780609);
   Graph_Graph_Graph_Graph1350135053509->SetMaximum(1.43501);
...
// ------------>Primitives in pad: HPlusBJetPt_1
   ...
   HPlusBJetPt_1->Draw();
   HPlusBJetPt_1->cd();
   HPlusBJetPt_1->Range(-113.924,-2.101009,848.1013,2.949428);
   ...
   hframe__836->SetMaximum(442.9977);
   ...
   StackedMCstackHist_stack_118_stack_119_stack_120->SetMinimum(0.001497128);
   StackedMCstackHist_stack_118_stack_119_stack_120->SetMaximum(113.6961);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,0.4170471);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(2,1.56705);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,0.7561767);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,0.4900045);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,0.2976645);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(6,0.1765422);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(7,0.1627691);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(8,0.1078562);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(9,0.06672511);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(10,0.02147784);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(11,0.007621267);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,0.03564153);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(2,0.06700092);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,0.04404374);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,0.03735376);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,0.03079397);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(6,0.02428956);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(7,0.0228891);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(8,0.02079254);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(9,0.01025058);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(10,0.007895361);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(11,0.002520813);
   tEWttX_stack_1_stack_1_stack_1->SetEntries(1408.885);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,6.969508);
   TT_stack_2_stack_2_stack_2->SetBinContent(2,21.60415);
   TT_stack_2_stack_2_stack_2->SetBinContent(3,9.023087);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,4.761749);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,2.798586);
   TT_stack_2_stack_2_stack_2->SetBinContent(6,1.821251);
   TT_stack_2_stack_2_stack_2->SetBinContent(7,1.303738);
   TT_stack_2_stack_2_stack_2->SetBinContent(8,0.8832746);
   TT_stack_2_stack_2_stack_2->SetBinContent(9,0.514622);
   TT_stack_2_stack_2_stack_2->SetBinContent(10,0.2182314);
   TT_stack_2_stack_2_stack_2->SetBinContent(11,0.07169745);
   TT_stack_2_stack_2_stack_2->SetBinError(1,0.09458348);
   TT_stack_2_stack_2_stack_2->SetBinError(2,0.1669814);
   TT_stack_2_stack_2_stack_2->SetBinError(3,0.1065273);
   TT_stack_2_stack_2_stack_2->SetBinError(4,0.07721413);
   TT_stack_2_stack_2_stack_2->SetBinError(5,0.05917919);
   TT_stack_2_stack_2_stack_2->SetBinError(6,0.04771229);
   TT_stack_2_stack_2_stack_2->SetBinError(7,0.04051701);
   TT_stack_2_stack_2_stack_2->SetBinError(8,0.03353514);
   TT_stack_2_stack_2_stack_2->SetBinError(9,0.01787571);
   TT_stack_2_stack_2_stack_2->SetBinError(10,0.0116009);
   TT_stack_2_stack_2_stack_2->SetBinError(11,0.004639702);
   TT_stack_2_stack_2_stack_2->SetEntries(39534.72);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,11.23084);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,39.07833);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,17.68592);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(4,9.331695);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,6.448694);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(6,3.979934);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(7,2.353815);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(8,2.000432);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(9,0.9470779);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(10,0.362379);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(11,0.1603071);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,0.5504719);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,1.020111);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,0.6840074);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(4,0.4930264);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,0.4002031);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(6,0.3135986);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(7,0.2441538);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(8,0.2206002);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(9,0.1087959);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(10,0.06965437);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(11,0.03076486);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetEntries(3590.445);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(1,0.1099664);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(2,0.4349982);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(3,0.2933308);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(4,0.3514198);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(5,0.4546098);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(6,0.5125763);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(7,0.5883985);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(8,0.3869872);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(9,0.1954696);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(10,0.03405793);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinContent(11,0.007547444);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(1,0.01426034);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(2,0.02945803);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(3,0.02584947);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(4,0.02594232);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(5,0.0282846);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(6,0.03135777);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(7,0.03267237);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(8,0.02864155);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(9,0.01377349);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(10,0.006816125);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetBinError(11,0.001933083);
   ChargedHiggs_HplusTBHplusToTB_M_800__837->SetEntries(1795.335);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors350235063510->SetMinimum(0.18757);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors350235063510->SetMaximum(69.59308);
   ...
   Data__838->SetBinContent(2,62.82);
   Data__838->SetBinContent(3,29.14);
   Data__838->SetBinContent(4,15.96);
   Data__838->SetBinContent(5,9.88);
   Data__838->SetBinContent(6,6.48);
   Data__838->SetBinContent(7,3.9);
   Data__838->SetBinContent(8,3.1);
   Data__838->SetBinContent(9,1.7);
   Data__838->SetBinContent(10,0.74);
   Data__838->SetBinContent(11,0.21);
   Data__838->SetBinError(1,0.629603);
   Data__838->SetBinError(2,1.120893);
   Data__838->SetBinError(3,0.7634134);
   Data__838->SetBinError(4,0.5649779);
   Data__838->SetBinError(5,0.4445222);
   Data__838->SetBinError(6,0.36);
   Data__838->SetBinError(7,0.2792848);
   Data__838->SetBinError(8,0.248998);
   Data__838->SetBinError(9,0.130384);
   Data__838->SetBinError(10,0.08602325);
   Data__838->SetBinError(11,0.0324037);
   Data__838->SetEntries(7756.998);
   ...
   hframe_copy__839->SetMaximum(442.9977);
   ...
   hframe_copy__840->SetMaximum(442.9977);
