...
// ------------>Primitives in pad: AssocTopMVA_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError345734613465->SetMinimum(0.9469041);
   Graph_Graph_Graph_BackgroundStatSystError345734613465->SetMaximum(1.053096);
   ...
   Graph_Graph_Graph_BackgroundStatError345834623466->SetMinimum(0.9469041);
   Graph_Graph_Graph_BackgroundStatError345834623466->SetMaximum(1.053096);
   ...
   Graph_Graph_Graph_Graph1345934633467->SetMinimum(0.9783289);
   Graph_Graph_Graph_Graph1345934633467->SetMaximum(1.110598);
...
// ------------>Primitives in pad: AssocTopMVA_1
   ...
   AssocTopMVA_1->Draw();
   AssocTopMVA_1->cd();
   AssocTopMVA_1->Range(-0.204557,-2.133152,1.073924,4.524449);
   ...
   StackedMCstackHist_stack_109_stack_110_stack_111->SetMinimum(0.7257798);
   StackedMCstackHist_stack_109_stack_110_stack_111->SetMaximum(2903.119);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(8,11.74619);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(9,50.07185);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(10,43.57944);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(11,46.80191);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(12,56.90069);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(8,1.319836);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(9,2.922741);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(10,2.478356);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(11,2.61336);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(12,2.764911);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(8,128.8801);
   TT_stack_2_stack_2_stack_2->SetBinContent(9,520.7013);
   TT_stack_2_stack_2_stack_2->SetBinContent(10,580.5296);
   TT_stack_2_stack_2_stack_2->SetBinContent(11,641.4065);
   TT_stack_2_stack_2_stack_2->SetBinContent(12,674.3745);
   TT_stack_2_stack_2_stack_2->SetBinError(8,2.842307);
   TT_stack_2_stack_2_stack_2->SetBinError(9,5.757517);
   TT_stack_2_stack_2_stack_2->SetBinError(10,6.078654);
   TT_stack_2_stack_2_stack_2->SetBinError(11,6.396074);
   TT_stack_2_stack_2_stack_2->SetBinError(12,6.559285);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(8,328.8513);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(9,1107.222);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(10,1150.467);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(11,1126.241);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(12,1055.709);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(8,20.53502);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(9,38.3144);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(10,38.74356);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(11,38.37967);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(12,37.34197);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(8,12.58978);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(9,36.27596);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(10,40.45478);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(11,43.05196);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(12,48.70411);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(8,1.012771);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(9,1.922681);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(10,2.011823);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(11,2.083696);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(12,2.146681);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetEntries(35807);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors346034643468->SetMinimum(2.038791);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors346034643468->SetMaximum(2038.791);
   ...
   Data__775->SetBinContent(8,494);
   Data__775->SetBinContent(9,1756);
   Data__775->SetBinContent(10,1905);
   Data__775->SetBinContent(11,1838);
   Data__775->SetBinContent(12,1848);
   Data__775->SetBinError(8,22.22611);
   Data__775->SetBinError(9,41.90465);
   Data__775->SetBinError(10,43.64631);
   Data__775->SetBinError(11,42.8719);
   Data__775->SetBinError(12,42.98837);
   Data__775->SetEntries(7845);
   ...
   hframe_copy__776->SetMaximum(13335);
   ...
   hframe_copy__777->SetMaximum(13335);
