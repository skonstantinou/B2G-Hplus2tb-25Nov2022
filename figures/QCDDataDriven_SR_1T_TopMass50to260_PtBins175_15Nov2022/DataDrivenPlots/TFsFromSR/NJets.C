...
//=========  (Fri Nov 18 13:30:02 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: NJets_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMinimum(0.987189);
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMaximum(1.012811);
   ...
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMinimum(0.987189);
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMaximum(1.012811);
   ...
   Graph_Graph_Graph_Graph1370537093713->SetMinimum(1.02808);
   Graph_Graph_Graph_Graph1370537093713->SetMaximum(1.056327);
...
// ------------>Primitives in pad: NJets_1
   ...
   NJets_1->Draw();
   NJets_1->cd();
   NJets_1->Range(5.379747,-1.223788,15.50633,5.120103);
   ...
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMinimum(101.3897);
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMaximum(9951.346);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,209.1001);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,5.558868);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,2545.892);
   TT_stack_2_stack_2_stack_2->SetBinError(1,12.73231);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,4768.49);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,79.10856);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinContent(1,181.0766);
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinError(1,4.209497);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMinimum(7427.099);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMaximum(7619.865);
   ...
   Data__1174->SetBinContent(1,7841);
   Data__1174->SetBinError(1,88.54942);
   ...
   hframe_copy__1175->SetMaximum(54887);
   ...
   hframe_copy__1176->SetMaximum(54887);
