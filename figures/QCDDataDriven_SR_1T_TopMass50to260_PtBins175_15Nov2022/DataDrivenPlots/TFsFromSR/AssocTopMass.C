...
// ------------>Primitives in pad: AssocTopMass_2
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMinimum(0.9438923);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMaximum(1.056108);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMinimum(0.9438923);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMaximum(1.056108);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMinimum(0.9438923);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMaximum(1.056108);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMinimum(0.9438923);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMaximum(1.056108);
   ...
   Graph_Graph_Graph_Graph0334133473353->SetMinimum(0.09214751);
   Graph_Graph_Graph_Graph0334133473353->SetMaximum(3.017577);
...
// ------------>Primitives in pad: AssocTopMass_1
   ...
   AssocTopMass_1->Draw();
   AssocTopMass_1->cd();
   AssocTopMass_1->Range(-202.5316,-1.220106,1063.291,4.939699);
   ...
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMinimum(1.255047);
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMaximum(5020.189);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,36.10334);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,142.858);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,30.13868);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,2.432723);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,4.559356);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,2.048204);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,430.645);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,1797.397);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,317.8493);
   TT_stack_2_stack_2_stack_2->SetBinError(3,5.228067);
   TT_stack_2_stack_2_stack_2->SetBinError(4,10.71761);
   TT_stack_2_stack_2_stack_2->SetBinError(5,4.462275);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,550.9781);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,799.7954);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,2789.63);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(6,628.0865);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,25.76177);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,32.37034);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,61.07281);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(6,28.57918);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(3,29.28531);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(4,129.5756);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(5,22.2157);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(3,1.708485);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(4,3.535493);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(5,1.516983);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetEntries(35807);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMinimum(3.518777);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMaximum(3518.777);
   ...
   Data__607->SetBinContent(3,1445);
   Data__607->SetBinContent(4,5309);
   Data__607->SetBinContent(5,1087);
   Data__607->SetBinError(3,38.01316);
   Data__607->SetBinError(4,72.86288);
   Data__607->SetBinError(5,32.96968);
   Data__607->SetEntries(7845);
   ...
   line = new TLine(173.21,0.08,173.21,37163);
   ...
   hframe_copy__608->SetMaximum(37163);
   ...
   hframe_copy__609->SetMaximum(37163);
