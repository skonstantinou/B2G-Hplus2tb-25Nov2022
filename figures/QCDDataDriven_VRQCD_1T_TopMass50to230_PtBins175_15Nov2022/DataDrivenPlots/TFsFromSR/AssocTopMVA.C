...
// ------------>Primitives in pad: AssocTopMVA_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError345734613465->SetMinimum(0.9319185);
   Graph_Graph_Graph_BackgroundStatSystError345734613465->SetMaximum(1.068081);
   ...
   Graph_Graph_Graph_BackgroundStatError345834623466->SetMinimum(0.9319185);
   Graph_Graph_Graph_BackgroundStatError345834623466->SetMaximum(1.068081);
   ...
   Graph_Graph_Graph_Graph1345934633467->SetMinimum(0.8878999);
   Graph_Graph_Graph_Graph1345934633467->SetMaximum(1.184298);
...
// ------------>Primitives in pad: AssocTopMVA_1
   ...
   AssocTopMVA_1->Draw();
   AssocTopMVA_1->cd();
   AssocTopMVA_1->Range(-0.204557,-2.134811,1.073924,4.605749);
   ...
   StackedMCstackHist_stack_109_stack_110_stack_111->SetMinimum(0.8185956);
   StackedMCstackHist_stack_109_stack_110_stack_111->SetMaximum(3274.382);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(8,8.965505);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(9,28.44765);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(10,23.84279);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(11,24.65847);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(12,28.34951);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(8,1.978444);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(9,3.24116);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(10,2.13243);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(11,2.681297);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(12,3.068573);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(8,78.30177);
   TT_stack_2_stack_2_stack_2->SetBinContent(9,302.398);
   TT_stack_2_stack_2_stack_2->SetBinContent(10,325.054);
   TT_stack_2_stack_2_stack_2->SetBinContent(11,337.0135);
   TT_stack_2_stack_2_stack_2->SetBinContent(12,323.5994);
   TT_stack_2_stack_2_stack_2->SetBinError(8,2.193253);
   TT_stack_2_stack_2_stack_2->SetBinError(9,4.309465);
   TT_stack_2_stack_2_stack_2->SetBinError(10,4.470741);
   TT_stack_2_stack_2_stack_2->SetBinError(11,4.543556);
   TT_stack_2_stack_2_stack_2->SetBinError(12,4.457365);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(8,501.5773);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(9,1668.688);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(10,1682.728);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(11,1684.817);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(12,1520.893);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(8,33.27701);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(9,60.84954);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(10,61.26894);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(11,61.02596);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(12,57.95744);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(8,0.4007221);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(9,1.530565);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(10,1.527999);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(11,0.9975961);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinContent(12,1.496973);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(8,0.2378871);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(9,0.4338546);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(10,0.4309378);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(11,0.4625493);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetBinError(12,0.4545348);
   ChargedHiggs_HplusTBHplusToTB_M_800__774->SetEntries(1103);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors346034643468->SetMinimum(2.318517);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors346034643468->SetMaximum(2318.517);
   ...
   Data__775->SetBinContent(8,596);
   Data__775->SetBinContent(9,2271);
   Data__775->SetBinContent(10,2130);
   Data__775->SetBinContent(11,1932);
   Data__775->SetBinContent(12,1751);
   Data__775->SetBinError(8,24.41311);
   Data__775->SetBinError(9,47.65501);
   Data__775->SetBinError(10,46.15192);
   Data__775->SetBinError(11,43.95452);
   Data__775->SetBinError(12,41.84495);
   Data__775->SetEntries(8684);
   ...
   hframe_copy__776->SetMaximum(15897);
   ...
   hframe_copy__777->SetMaximum(15897);
