...
//=========  (Fri Nov 18 13:30:28 2022) by ROOT version 6.20/02
...
// ------------>Primitives in pad: NJets_2
   ...
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMinimum(0.9823548);
   Graph_Graph_Graph_BackgroundStatSystError370337073711->SetMaximum(1.017645);
   ...
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMinimum(0.9823548);
   Graph_Graph_Graph_BackgroundStatError370437083712->SetMaximum(1.017645);
   ...
   Graph_Graph_Graph_Graph1370537093713->SetMinimum(1.00338);
   Graph_Graph_Graph_Graph1370537093713->SetMaximum(1.029565);
...
// ------------>Primitives in pad: NJets_1
   ...
   NJets_1->Draw();
   NJets_1->cd();
   NJets_1->Range(5.379747,-1.224748,15.50633,5.16713);
   ...
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMinimum(49.44496);
   StackedMCstackHist_stack_166_stack_167_stack_168->SetMaximum(11856.96);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(1,114.2639);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(1,5.964236);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(1,1366.367);
   TT_stack_2_stack_2_stack_2->SetBinError(1,9.158677);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(1,7058.704);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(1,125.0885);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinContent(1,5.953856);
   ChargedHiggs_HplusTBHplusToTB_M_800__1173->SetBinError(1,0.9225406);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMinimum(8388.656);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors370637103714->SetMaximum(8690.012);
   ...
   Data__1174->SetBinContent(1,8680);
   Data__1174->SetBinError(1,93.16652);
   ...
   hframe_copy__1175->SetMaximum(60760);
   ...
   hframe_copy__1176->SetMaximum(60760);
