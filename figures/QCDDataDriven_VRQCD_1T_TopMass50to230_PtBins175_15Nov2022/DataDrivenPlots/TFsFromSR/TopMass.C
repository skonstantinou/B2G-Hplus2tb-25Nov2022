...
// ------------>Primitives in pad: TopMass_2
   ...
   Double_t BackgroundStatSystError_fx3409[4] = {
   75,
   125,
   175,
   225};
   Double_t BackgroundStatSystError_fy3409[4] = {
   1,
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3409[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fely3409[4] = {
   0.04743918,
   0.02468269,
   0.05092909,
   0.02153937};
   Double_t BackgroundStatSystError_fehx3409[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fehy3409[4] = {
   0.04743918,
   0.02468269,
   0.05092909,
   0.02153937};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(4,BackgroundStatSystError_fx3409,BackgroundStatSystError_fy3409,BackgroundStatSystError_felx3409,BackgroundStatSystError_fehx3409,BackgroundStatSystError_fely3409,BackgroundStatSystError_fehy3409);
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409 = new TH1F("Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409","Graph",100,30,270);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409->SetMinimum(0.9388851);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33973399340334053409->SetMaximum(1.061115);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33983400340434063410->SetMinimum(0.9388851);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33983400340434063410->SetMaximum(1.061115);
   ...
   Double_t BackgroundStatSystError_fx3411[4] = {
   75,
   125,
   175,
   225};
   Double_t BackgroundStatSystError_fy3411[4] = {
   1,
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3411[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fely3411[4] = {
   0.04743918,
   0.02468269,
   0.05092909,
   0.02153937};
   Double_t BackgroundStatSystError_fehx3411[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fehy3411[4] = {
   0.04743918,
   0.02468269,
   0.05092909,
   0.02153937};
   grae = new TGraphAsymmErrors(4,BackgroundStatSystError_fx3411,BackgroundStatSystError_fy3411,BackgroundStatSystError_felx3411,BackgroundStatSystError_fehx3411,BackgroundStatSystError_fely3411,BackgroundStatSystError_fehy3411);
   grae->SetName("BackgroundStatSystError");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411 = new TH1F("Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411","Graph",100,30,270);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411->SetMinimum(0.9388851);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError339733993403340534093411->SetMaximum(1.061115);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError339834003404340634103412->SetMinimum(0.9388851);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError339834003404340634103412->SetMaximum(1.061115);
   ...
   Double_t Graph0_fx3413[4] = {
   75,
   125,
   175,
   225};
   Double_t Graph0_fy3413[4] = {
   1.012765,
   1.03295,
   0.9900976,
   1.009208};
   Double_t Graph0_felx3413[4] = {
   25,
   25,
   25,
   25};
   Double_t Graph0_fely3413[4] = {
   0.03433594,
   0.01845731,
   0.03813713,
   0.01594901};
   Double_t Graph0_fehx3413[4] = {
   25,
   25,
   25,
   25};
   Double_t Graph0_fehy3413[4] = {
   0.03433594,
   0.01845731,
   0.03813713,
   0.01594901};
   grae = new TGraphAsymmErrors(4,Graph0_fx3413,Graph0_fy3413,Graph0_felx3413,Graph0_fehx3413,Graph0_fely3413,Graph0_fehy3413);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph0340134073413 = new TH1F("Graph_Graph_Graph_Graph0340134073413","Graph",100,30,270);
   Graph_Graph_Graph_Graph0340134073413->SetMinimum(0.9420158);
   Graph_Graph_Graph_Graph0340134073413->SetMaximum(1.061352);
...
// ------------>Primitives in pad: TopMass_1
   ...
   TopMass_1->Draw();
   TopMass_1->cd();
   TopMass_1->Range(-202.5316,-1.217557,1063.291,4.814808);
   ...
   hframe__689->SetMaximum(28370.46);
   ...
   StackedMCstackHist_stack_97_stack_98_stack_99->SetMinimum(1.586987);
   StackedMCstackHist_stack_97_stack_98_stack_99->SetMaximum(6347.946);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(2,8.580313);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,39.9268);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,12.4858);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,53.271);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(2,2.068522);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,3.828453);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,1.428568);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,3.820402);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(2,71.56693);
   TT_stack_2_stack_2_stack_2->SetBinContent(3,467.2341);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,173.7363);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,653.8292);
   TT_stack_2_stack_2_stack_2->SetBinError(2,2.116249);
   TT_stack_2_stack_2_stack_2->SetBinError(3,5.346158);
   TT_stack_2_stack_2_stack_2->SetBinError(4,3.237377);
   TT_stack_2_stack_2_stack_2->SetBinError(5,6.351444);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,778.8873);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,2524.931);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(4,494.5189);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,3260.366);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,40.64431);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,74.55075);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(4,34.48846);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,85.13468);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(2,0.4066615);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(3,2.000939);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(4,0.2800914);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinContent(5,3.266163);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(2,0.1621757);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(3,0.4823625);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(4,0.3189426);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetBinError(5,0.700273);
   ChargedHiggs_HplusTBHplusToTB_M_800__690->SetEntries(1103);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors340234083414->SetMinimum(4.458215);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors340234083414->SetMaximum(4458.215);
   ...
   Data__691->SetBinContent(2,870);
   Data__691->SetBinContent(3,3132);
   Data__691->SetBinContent(4,674);
   Data__691->SetBinContent(5,4004);
   Data__691->SetBinError(2,29.49576);
   Data__691->SetBinError(3,55.96427);
   Data__691->SetBinError(4,25.96151);
   Data__691->SetBinError(5,63.27717);
   Data__691->SetEntries(8684);
   ...
   line = new TLine(173.21,0.08,173.21,28370.46);
   ...
   hframe_copy__692->SetMaximum(28370.46);
   ...
   hframe_copy__693->SetMaximum(28370.46);
