...
// ------------>Primitives in pad: AssocTopMass_2
   ...
   Double_t BackgroundStatSystError_fx3349[4] = {
   75,
   125,
   175,
   225};
   Double_t BackgroundStatSystError_fy3349[4] = {
   1,
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3349[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fely3349[4] = {
   0.05518882,
   0.03235007,
   0.008716896,
   0.02085285};
   Double_t BackgroundStatSystError_fehx3349[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fehy3349[4] = {
   0.05518882,
   0.03235007,
   0.008716896,
   0.02085285};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(4,BackgroundStatSystError_fx3349,BackgroundStatSystError_fy3349,BackgroundStatSystError_felx3349,BackgroundStatSystError_fehx3349,BackgroundStatSystError_fely3349,BackgroundStatSystError_fehy3349);
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349 = new TH1F("Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349","Graph",100,30,270);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMinimum(0.9337734);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError33373339334333453349->SetMaximum(1.066227);
   ...
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMinimum(0.9337734);
   Graph_Graph_Graph_Graph_Graph_BackgroundStatError33383340334433463350->SetMaximum(1.066227);
   ...
   Double_t BackgroundStatSystError_fx3351[4] = {
   75,
   125,
   175,
   225};
   Double_t BackgroundStatSystError_fy3351[4] = {
   1,
   1,
   1,
   1};
   Double_t BackgroundStatSystError_felx3351[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fely3351[4] = {
   0.05518882,
   0.03235007,
   0.008716896,
   0.02085285};
   Double_t BackgroundStatSystError_fehx3351[4] = {
   25,
   25,
   25,
   25};
   Double_t BackgroundStatSystError_fehy3351[4] = {
   0.05518882,
   0.03235007,
   0.008716896,
   0.02085285};
   grae = new TGraphAsymmErrors(4,BackgroundStatSystError_fx3351,BackgroundStatSystError_fy3351,BackgroundStatSystError_felx3351,BackgroundStatSystError_fehx3351,BackgroundStatSystError_fely3351,BackgroundStatSystError_fehy3351);
   grae->SetName("BackgroundStatSystError");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351 = new TH1F("Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351","Graph",100,30,270);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMinimum(0.9337734);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatSystError333733393343334533493351->SetMaximum(1.066227);
   ...
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMinimum(0.9337734);
   Graph_Graph_Graph_Graph_Graph_Graph_BackgroundStatError333833403344334633503352->SetMaximum(1.066227);
   ...
   Graph_Graph_Graph_Graph0334133473353->SetMinimum(0.2462248);
   Graph_Graph_Graph_Graph0334133473353->SetMaximum(6.382893);
...
// ------------>Primitives in pad: AssocTopMass_1
   ...
   AssocTopMass_1->Draw();
   AssocTopMass_1->cd();
   AssocTopMass_1->Range(-202.5316,-1.221319,1063.291,4.999147);
   ...
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMinimum(1.973452);
   StackedMCstackHist_stack_85_stack_86_stack_87->SetMaximum(7893.807);
   ...
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(3,20.60503);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(4,74.60068);
   tEWttX_stack_1_stack_1_stack_1->SetBinContent(5,19.0582);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(3,2.360653);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(4,4.872932);
   tEWttX_stack_1_stack_1_stack_1->SetBinError(5,2.500794);
   ...
   TT_stack_2_stack_2_stack_2->SetBinContent(3,199.5981);
   TT_stack_2_stack_2_stack_2->SetBinContent(4,974.6824);
   TT_stack_2_stack_2_stack_2->SetBinContent(5,192.086);
   TT_stack_2_stack_2_stack_2->SetBinError(3,3.501858);
   TT_stack_2_stack_2_stack_2->SetBinError(4,7.740339);
   TT_stack_2_stack_2_stack_2->SetBinError(5,3.421333);
   ...
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(2,698.6864);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(3,1637.532);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinContent(5,4722.485);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(2,38.55968);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(3,59.94928);
   BkgSummISRmIInclusive_stack_3_stack_3_stack_3->SetBinError(5,102.7929);
   ...
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(3,0.7806473);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(4,3.695508);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinContent(5,1.477701);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(3,0.3490212);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(4,0.7632118);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetBinError(5,0.3831098);
   ChargedHiggs_HplusTBHplusToTB_M_800__606->SetEntries(1103);
   ...
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMinimum(5.540161);
   Graph_Graph_Graph_BkgSummISRmIInclusive_sum_errors334233483354->SetMaximum(5540.161);
   ...
   Data__607->SetBinContent(3,1256);
   Data__607->SetBinContent(4,6037);
   Data__607->SetBinContent(5,1387);
   Data__607->SetBinError(3,35.44009);
   Data__607->SetBinError(4,77.69813);
   Data__607->SetBinError(5,37.24245);
   Data__607->SetEntries(8684);
   ...
   line = new TLine(173.21,0.08,173.21,42259);
   ...
   hframe_copy__608->SetMaximum(42259);
   ...
   hframe_copy__609->SetMaximum(42259);
