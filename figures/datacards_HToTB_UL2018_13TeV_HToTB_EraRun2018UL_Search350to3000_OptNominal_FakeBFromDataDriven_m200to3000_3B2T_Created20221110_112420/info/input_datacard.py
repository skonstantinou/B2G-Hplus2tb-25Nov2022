...
OptionCategory                         = "3B2T"  # options: "3B1T", "3B2T"
OptionFinalState                       = "HToTB" 
OptionChannelLabel                     = "HToTB"
OptionMassShape                        = "h3B2T_MVAOutput_M%s_AfterSelections"
...
# Custom for HToTB 3B2T Category
HToTB_RFScale = Nuisance(id="QCDscale_HToTB_ACCEPT", label="Scale acceptance for signal"          , distr="lnN", function="Constant", value=0.035, upperValue=0.049)
TT_RFScale    = Nuisance(id="QCDscale_top_ACCEPT"  , label="Scale acceptance for top"             , distr="lnN", function="Constant", value=0.021)
