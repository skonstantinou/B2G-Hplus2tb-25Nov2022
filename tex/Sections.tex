...
\Slide{t}{
  ...
  \begin{itemize}
    \small
  \item Further categorization:
    \begin{itemize}
      \footnotesize
    \item top tagging rate (high/low purity)
    \item Number of extra b jets \ProgressTag
    \end{itemize}
  \end{itemize}
    ...
    \end{column}
     \begin{column}{0.52\textwidth}
       ...
       \item Training on simulated $t\bar{t}$ events
         ...
         \item[] \footnotesize{\textcolor{white}{Background:} ($\ge$ 1 non-matched q from t)}
        \end{itemize}
       \end{itemize}
     \end{column}
