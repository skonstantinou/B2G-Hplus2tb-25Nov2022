  ...
  \twoColumnsAsymAlt
      {
        ...
        \item Validated in regions with == 2 b jets
        \end{itemize}
      }
      {
        \vspace{-3.5cm}
...
\Slide{t}{
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      \small
      %Parameterized DNN trained with 6 \mHpm hypotheses
      Parameterized DNN is trained using 6 different mass hypotheses.
      \begin{itemize}
        \scriptsize
      \item Training masses = [220, 350, 600, 1000, 1500, 2500] GeV \SolidLineTag
  ...
  \begin{center}
    \resizebox{0.95\linewidth}{!}{
      \begin{tabular}{l l l}
        ...
        \textbf{SR1} & \textbf{SR2} & \\
        \hline
        \cellcolor[gray]{.9}Trigger & \cellcolor[gray]{.9}Trigger & \cellcolor[gray]{.9}same as resolved\\%& \cellcolor[gray]{.9}\begin{tabular}{@{}c@{}} $H_{T}$ + multijet + 1 or 2 b jets\\  $H_{T}$ + AK8 jet + trim mass $ \ \ $ \end{tabular}\\
...
\Slide{t}{
  ...
  Efficiency in Data: Simultaneous fit of all jet types, for
    ...
    \begin{columns}[T]
      \begin{column}{0.5\textwidth}
        \oneFigColumns{SF_PNet_TvsQCD_Pass.png}{Pass, TvsQCD, 2018, misID=1$\%$}{0.81}
        \PlaceText{16mm}{55mm}{\tiny{\textcolor{red}{300~<~\pT~<~400\GeV}}}        
      \end{column}
      \begin{column}{0.5\textwidth}
...
\Slide{t}{
  ...
  \item Boosted Analysis:
    \begin{itemize}
      \footnotesize
    \item Boosted jet-flavour indentification with  \texttt{ParticleNet}% (mva-based)
    \item \texttt{ParticleNet} W/t re-calibration
